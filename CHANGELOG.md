...
- На daily-мозаику фотографий в digest добавлена дата отчёта в формате `ДД/ММ/ГГ` в правом нижнем углу.
- Weekly-мозаика теперь визуально отличается от daily: показывает диапазон дат в формате `05-11 мая '26` в левом верхнем углу и использует отдельные цвета рамки и плашки.
